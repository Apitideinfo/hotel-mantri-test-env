...
-- Add provider-neutral fields to channel_connections
ALTER TABLE channel_connections
ADD COLUMN IF NOT EXISTS provider text DEFAULT 'aiosell',
ADD COLUMN IF NOT EXISTS external_hotel_code text,
ADD COLUMN IF NOT EXISTS external_partner_id text;

-- Add provider-neutral fields to channel_rate_mappings
ALTER TABLE channel_rate_mappings
ADD COLUMN IF NOT EXISTS provider text DEFAULT 'aiosell',
ADD COLUMN IF NOT EXISTS external_room_code text,
ADD COLUMN IF NOT EXISTS external_rate_plan_code text;

-- Add Aiosell specific configuration to channel_settings
ALTER TABLE channel_settings
ADD COLUMN IF NOT EXISTS aiosell_status text DEFAULT 'disconnected',
ADD COLUMN IF NOT EXISTS aiosell_environment text DEFAULT 'test',
ADD COLUMN IF NOT EXISTS aiosell_hotel_code text,
ADD COLUMN IF NOT EXISTS aiosell_partner_id text;
