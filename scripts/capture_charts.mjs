...
try {
  const targetsRes = await fetch('http://127.0.0.1:9228/json/list');
  ...
  fs.writeFileSync('C:/Users/india/.gemini/antigravity-ide/brain/ee8696dc-d1ad-40f5-ba99-7cea110154a6/scratch/dashboard_charts_live.png', Buffer.from(ss.data, 'base64'));
  console.log('Saved dashboard_charts_live.png');
